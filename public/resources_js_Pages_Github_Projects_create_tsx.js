(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Github_Projects_create_tsx"],{
...
var Sidebar = function Sidebar(_a) {
  ...
  var sharedRepoOpenWhen = ['github', 'gitlab'];

  var _b = react_1.useState(sharedRepoOpenWhen.includes(route_name)),
      sharedRepoOpen = _b[0],
      setSharedRepoOpen = _b[1];
  ...
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("div", {
  ...
  }, "Repo Share")), react_1["default"].createElement("div", {
    ...
    onClick: function onClick() {
      return setSharedRepoOpen(!sharedRepoOpen);
    }
  }, react_1["default"].createElement("svg", {
    className: "mr-4 h-6 w-6 text-gray-300 group-hover:text-gray-200 group-focus:text-gray-200 transition ease-in-out duration-150",
    fill: "none",
  ...
  })), "Shared repository"), react_1["default"].createElement(framer_motion_1.motion.nav, {
    animate: sharedRepoOpen ? "open" : "closed",
    variants: variants,
    className: "" + (!sharedRepoOpen && 'hidden')
  }, react_1["default"].createElement("div", {
    className: "mt-1 space-y-1"
  }, react_1["default"].createElement(inertia_react_1.InertiaLink, {
    href: "/github",
    className: (route_name == 'github' ? 'bg-primary focus:bg-primary-lighter' : 'hover:bg-black-light focus:bg-black-light') + " group w-full flex items-center pl-10 pr-2 py-2 text-sm leading-6 font-medium rounded-md text-gray-100 hover:text-white focus:outline-none transition ease-in-out duration-150"
  }, "Github"), react_1["default"].createElement(inertia_react_1.InertiaLink, {
    href: "/gitlab",
    className: (route_name == 'gitlab' ? 'bg-primary focus:bg-primary-lighter' : 'hover:bg-black-light focus:bg-black-light') + " group w-full flex items-center pl-10 pr-2 py-2 text-sm leading-6 font-medium rounded-md text-gray-100 hover:text-white focus:outline-none transition ease-in-out duration-150"
  }, "Gitlab")))))), react_1["default"].createElement("hr", {
    className: "h-px mt-6 bg-gray-700 border-none"
  }), react_1["default"].createElement("div", {
    className: "mt-6 flex-1 h-0 overflow-y-auto"
  }, react_1["default"].createElement("nav", {
...
/***/ "./resources/js/Pages/Github/Projects/create.tsx":
/*!*******************************************************!*\
  !*** ./resources/js/Pages/Github/Projects/create.tsx ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var Project = function Project(_a) {
  ...
  return React.createElement(NestedLayout_1["default"], {
  ...
  }, "This information will be displayed publicly so be careful what you share."))), React.createElement("div", {
  ...
  }, "Global description for your project. URLs are hyperlinked.")), React.createElement("div", null, React.createElement("label", {
    className: "block text-sm font-medium text-gray-700"
  ...
  }, "Change"))), React.createElement("div", null, React.createElement("label", {
    className: "block text-sm font-medium text-gray-700"
  }, "Cover photo"), React.createElement("div", {
  ...
  }, React.createElement("span", null, "Upload a file"), React.createElement("input", {
    id: "file-upload",
    name: "file-upload",
    type: "file",
    className: "sr-only"
    ...
    className: "pl-1"
  }, "or drag and drop")), React.createElement("p", {
    className: "text-xs text-gray-500"
  }, "PNG, JPG, GIF up to 10MB"))))), React.createElement("div", {
    ...
    className: "text-lg font-medium leading-6 text-gray-900"
  }, "Personal Information"), React.createElement("p", {
    className: "mt-1 text-sm text-gray-600"
  }, "Use a permanent address where you can receive mail."))), React.createElement("div", {
    className: "mt-5 md:mt-0 md:col-span-2"
  }, React.createElement("form", {
    action: "#",
    method: "POST"
    ...
    htmlFor: "country",
    className: "block text-sm font-medium text-gray-700"
  }, "Country / Region"), React.createElement("select", {
    id: "country",
    name: "country",
    autoComplete: "country",
    className: "mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
  }, React.createElement("option", null, "United States"), React.createElement("option", null, "Canada"), React.createElement("option", null, "Mexico"))), React.createElement("div", {
    ...
    htmlFor: "postal_code",
    className: "block text-sm font-medium text-gray-700"
  }, "ZIP / Postal"), React.createElement("input", {
    type: "text",
    name: "postal_code",
    id: "postal_code",
    ...
    className: "mt-1 text-sm text-gray-600"
  }, "Decide which communications you'd like to receive and how."))), React.createElement("div", {
    className: "mt-5 md:mt-0 md:col-span-2"
  }, React.createElement("form", {
    action: "#",
    method: "POST"
  ...
  }, "By Email"), React.createElement("div", {
  ...
  }, "Get notified when someones posts a comment on a posting."))), React.createElement("div", {
    className: "flex items-start"
  }, React.createElement("div", {
    className: "flex items-center h-5"
  }, React.createElement("input", {
    ...
    htmlFor: "candidates",
    className: "font-medium text-gray-700"
  }, "Candidates"), React.createElement("p", {
    className: "text-gray-500"
  }, "Get notified when a candidate applies for a job."))), React.createElement("div", {
    className: "flex items-start"
  }, React.createElement("div", {
    className: "flex items-center h-5"
  }, React.createElement("input", {
    ...
    htmlFor: "offers",
    className: "font-medium text-gray-700"
  }, "Offers"), React.createElement("p", {
    className: "text-gray-500"
  }, "Get notified when a candidate accepts or rejects an offer."))))), React.createElement("fieldset", null, React.createElement("div", null, React.createElement("legend", {
    className: "text-base font-medium text-gray-900"
  }, "Push Notifications"), React.createElement("p", {
    className: "text-sm text-gray-500"
  }, "These are delivered via SMS to your mobile phone.")), React.createElement("div", {
    className: "mt-4 space-y-4"
  }, React.createElement("div", {
    ...
    htmlFor: "push_email",
    className: "ml-3 block text-sm font-medium text-gray-700"
  }, "Same as email")), React.createElement("div", {
    className: "flex items-center"
  }, React.createElement("input", {
    id: "push_nothing",
    name: "push_notifications",
    ...
    className: "ml-3 block text-sm font-medium text-gray-700"
  }, "No push notifications"))))), React.createElement("div", {
    className: "px-4 py-3 bg-gray-50 text-right sm:px-6"
  }, React.createElement("button", {
    type: "submit",
    className: "inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
...
/* harmony export */   "createCrossfadeState": () => (/* binding */ createCrossfadeState),
...
function useVisualElementContext() {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(MotionContext).parent;
}
    ...
    return {
        ...
        notify: function (a, b, c) {
            ...
            if (!subscriptions.size)
                return;
            try {
                for (var subscriptions_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__values)(subscriptions), subscriptions_1_1 = subscriptions_1.next(); !subscriptions_1_1.done; subscriptions_1_1 = subscriptions_1.next()) {
...
var easingDefinitionToFunction = function (definition) {
    if (Array.isArray(definition)) {
        ...
        (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(definition.length === 4, "Cubic bezier arrays must contain four numerical values.");
        ...
        (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(easingLookup[definition] !== undefined, "Invalid easing type '" + definition + "'");
...
function convertTransitionToAnimationOptions(_a) {
     ...
     */
    if (yoyo || loop || flip) {
        (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.warning)(!legacyRepeatWarning, "yoyo, loop and flip have been removed from the API. Replace with repeat and repeatType options.");
...
function getAnimation(key, value, target, transition, onComplete) {
    ...
    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.warning)(isOriginAnimatable === isTargetAnimatable, "You are trying to animate " + key + " from \"" + origin + "\" to \"" + target + "\". " + origin + " is not an animatable value - to enable this animation set " + origin + " to a value animatable to " + target + " via the `style` property.");
    function start() {
        var options = {
            from: origin,
            to: target,
...
function checkTargetForNewValues(visualElement, target, origin) {
    ...
    for (var i = 0; i < numNewValues; i++) {
        ...
        if (value === null) {
            ...
            (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(value !== null, "No initial value for \"" + key + "\" can be inferred. Ensure an initial value for \"" + key + "\" is defined on the component.");
        }
...
function animateChildren(visualElement, variant, delayChildren, staggerChildren, staggerDirection, options) {
    ...
    Array.from(visualElement.variantChildren).forEach(function (child, i) {
        animations.push(animateVariant(child, variant, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, options), { delay: delayChildren + generateStaggerDuration(i) })));
    });
...
function animationControls() {
    ...
    var controls = {
        ...
        set: function (definition) {
            (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(hasMounted, "controls.set() should only be called after a component has mounted. Consider calling within a useEffect hook.");
...
function getVariableValue(current, element, depth) {
    ...
    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(depth <= maxDepth, "Max CSS variable fallback depth detected in property \"" + current + "\". This may indicate a circular fallback dependency.");
...
var visualElement = function (_a) {
    ...
    return function (_a, options) {
         ...
         */
        var baseTarget = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, visualState.values);
        // Internal methods ========================
        /**
         ...
         */
        function unmount() {
            framesync__WEBPACK_IMPORTED_MODULE_1__.cancelSync.update(update);
            framesync__WEBPACK_IMPORTED_MODULE_1__.cancelSync.render(render);
            framesync__WEBPACK_IMPORTED_MODULE_1__.cancelSync.preRender(element.updateLayoutProjection);
        ...
        function bindToMotionValue(key, value) {
            var removeOnChange = value.onChange(function (latestValue) {
                ...
                props.onUpdate && framesync__WEBPACK_IMPORTED_MODULE_1__.default.update(update, false, true);
            });
        ...
        var element = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({ 
            /**
            ...
            scheduleUpdateLayoutProjection: parent
                ...
                : function () { return framesync__WEBPACK_IMPORTED_MODULE_1__.default.preRender(element.updateLayoutProjection, false, true); }, 
            /**
            ...
            scheduleRender: function () {
                framesync__WEBPACK_IMPORTED_MODULE_1__.default.render(render, false, true);
            },
            /**
            ...
            updateLayoutMeasurement: function () {
                ...
                framesync__WEBPACK_IMPORTED_MODULE_1__.default.update(function () { return element.rebaseProjectionTarget(); });
            },
            /**
            ...
            pointTo: function (newLead) {
                ...
                unsubscribeFromLeadVisualElement = (0,popmotion__WEBPACK_IMPORTED_MODULE_4__.pipe)(newLead.onSetAxisTarget(element.scheduleUpdateLayoutProjection), newLead.onRender(render));
            }, 
            // TODO: Clean this up
        ...
        if (isKeyframesTarget(to)) {
            ...
            for (var i = to[0] === null ? 1 : 0; i < numKeyframes; i++) {
                if (!toType) {
                    ...
                    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(toType === fromType ||
                        (isNumOrPxType(fromType) && isNumOrPxType(toType)), "Keyframes must be of the same dimension as the current value");
                }
                else {
                    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(findDimensionValueType(to[i]) === toType, "All keyframes must be of the same type");
                }
            }
        }
        else {
...
function buildSVGAttrs(state, _a, layoutState, options, transformTemplate) {
    ...
    latest = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__rest)(values, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]);
...
function useSnapshotOfLeadVisualElement(layoutId) {
    ...
    return useConstant(function () {
        ...
        return lead ? (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, lead.getLatestValues()) : undefined;
    });
}
function useDomVisualElement(Component, props, isStatic, ref) {
    var motionContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(MotionContext);
    ...
    var visualElementRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    ...
    useIsomorphicLayoutEffect(function () {
        var _a;
        visualElement.updateProps((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, props), { layoutId: layoutId }));
        /**
...
function MotionConfig(_a) {
    ...
    var value = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () { return ({ features: loadedFeatures }); }, [
...
function useRender(Component, props, visualElement) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Component, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, forwardedProps), { ref: visualElement.ref }), visualProps));
}
...
function useFeatures(defaultFeatures, isStatic, visualElement, props) {
    var plugins = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(MotionConfigContext);
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (shouldRender(props)) {
            ...
            Component &&
                features.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Component, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({ key: key }, props, { visualElement: visualElement })));
        }
    }
    return features;
}
...
function createMotionComponent(Component, _a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        return ((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(MotionContext.Provider, { value: motionContext }, component),
            features));
    }
...
var VisualElementDragControls = /** @class */ (function () {
    ...
    VisualElementDragControls.prototype.resolveRefConstraints = function (layoutBox, constraints) {
        ...
        (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(constraintsElement !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
...
function AnimateLayoutContextProvider(props) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Animate, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, props, { safeToRemove: safeToRemove }));
}
...
function MeasureContextProvider(props) {
    var syncLayout = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(SharedLayoutContext);
    var framerSyncLayout = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(FramerTreeLayoutContext);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Measure, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, props, { syncLayout: syncLayout, framerSyncLayout: framerSyncLayout })));
}
var MeasureLayout = {
    key: "measure-layout",
    shouldRender: function (props) {
...
function useForceUpdate() {
    ...
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0), 2), forcedRenderCount = _a[0], setForcedRenderCount = _a[1];
...
var AnimatePresence = function (_a) {
    ...
    if (isInitialRender.current) {
        ...
        return ((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, filteredChildren.map(function (child) { return ((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(PresenceChild, { key: getChildKey(child), isPresent: true, initial: initial ? undefined : false, presenceAffectsLayout: presenceAffectsLayout }, child)); })));
    }
    ...
    exiting.forEach(function (key) {
        ...
        childrenToRender.splice(insertionIndex, 0, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(PresenceChild, { key: getChildKey(child), isPresent: false, onExitComplete: onExit, custom: custom, presenceAffectsLayout: presenceAffectsLayout }, child));
    });
    // Add `MotionContext` even to children that don't need it to ensure we're rendering
    // the same tree between renders
    childrenToRender = childrenToRender.map(function (child) {
        var key = child.key;
        return exiting.has(key) ? (child) : ((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(PresenceChild, { key: getChildKey(child), isPresent: true, presenceAffectsLayout: presenceAffectsLayout }, child));
    });
...
function createCrossfadeState(state, forceCrossfade) {
    ...
    function animateProgress(to, transition) {
        ...
        animate(crossfadeProgress, to, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, (transition ||
    ...
    function updateValues() {
        ...
        if (forceCrossfade || follow.isPresenceRoot || lead.isPresenceRoot) {
            ...
            leadValues.values.opacity = (0,popmotion__WEBPACK_IMPORTED_MODULE_4__.mix)(0, leadTargetOpacity, easeCrossfadeIn(p));
        }
...
function mixBorderRadius(from, to, fromValues, toValues, p) {
    ...
    for (var i = 0; i < numBorders; i++) {
        ...
        if (typeof fromRadius === "number" && typeof toRadius === "number") {
            fromValues[borderLabel] = toValues[borderLabel] = (0,popmotion__WEBPACK_IMPORTED_MODULE_4__.mix)(fromRadius, toRadius, p);
        }
    }
    if (fromLatest.rotate || toLatest.rotate) {
        fromValues.rotate = toValues.rotate = (0,popmotion__WEBPACK_IMPORTED_MODULE_4__.mix)(fromLatest.rotate || 0, toLatest.rotate || 0, p);
    }
}
...
function useElementScroll(ref) {
    ...
    useIsomorphicLayoutEffect(function () {
        var element = ref.current;
        (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(!!element, "ref provided to useScroll must be passed into a HTML element.");
        if (!element)
            return;
...
function useReducedMotion() {
    ...
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(prefersReducedMotion.get()), 2), shouldReduceMotion = _a[0], setShouldReduceMotion = _a[1];
...
function useCycle() {
    ...
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(items[index.current]), 2), item = _a[0], setItem = _a[1];
    return [
        item,
        function (next) {
            index.current =
...
function useInvertedScale(scale) {
    ...
    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.invariant)(!!(scale || visualElement), "If no scale values are provided, useInvertedScale must be used within a child of another motion component.");
    (0,hey_listen__WEBPACK_IMPORTED_MODULE_2__.warning)(hasWarned, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead.");
    hasWarned = true;
    if (scale) {
