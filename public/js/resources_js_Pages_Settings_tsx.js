...
var framer_motion_1 = __webpack_require__(/*! framer-motion */ "./node_modules/framer-motion/dist/framer-motion.cjs.js");
...
var Settings = function Settings(_a) {
  ...
  var clearPasswordValues = function clearPasswordValues() {
    setPasswordValues({
      current_password: '',
      password: '',
      password_confirmation: ''
  ...
  var profileSubmit = function profileSubmit(e) {
    e.preventDefault();
    return inertia_1.Inertia.put("user/profile-information", profileValues);
  };
  ...
  }, React.createElement(ErrorBanner_1["default"], {
